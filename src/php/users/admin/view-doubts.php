...
<body>
    <div id="back-btn"><a href="http://localhost/QuantE-FY/src/php/users/admin/admin.php"><button>Back</button></a></div>
        ...
        if (mysqli_num_rows ( $result ) > 0) {
            // output data of each row
                ...
                <table style="text-align: center;">
                    <tr>
                        <th style="text-align: center; background: rgb(39, 39, 39); color: white; min-width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
