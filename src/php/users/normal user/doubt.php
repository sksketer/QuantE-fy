...
<body>
    ...
    <div class="container">
       <div class="nav">
            <a href="http://localhost/QuantE-FY/src/php/users/ask2.php"><span id="back-btn">go back</span></a>
       ...
       <div class="main">
            <form action="http://localhost/QuantE-FY/src/php/users/normal%20user/submit-doubt.php" method="post">
                ...
                <textarea name="question" id="area" cols="80" rows="10" spellxcheck="true" placeholder="Question"></textarea> <br> <br>
