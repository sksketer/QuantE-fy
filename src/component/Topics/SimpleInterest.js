    ...
    return (
            <div className="main-heading">
                    ...
                    <div className="tips">
                        ...
                        <b>sol.</b> Applyinng formula Amount = Principal + Simple Interest <br></br> 5400 = P*(1+(5*4)/100) = 4500 <br></br> Required Amount = p*(1+(R*T)/100)<br></br> Amount = 4500(1+(10*3)/100) = 5850</p><br></br>
                        ...
                        <p className="def"><b> 10) An agent allows a rebate of 4% to an investor while the bank pays an interest of 14% on the investement .What is the actual rate of interest earned by the investor on his investement?</b><br></br>
